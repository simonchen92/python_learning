...
# To start you off, we've provided a dictionary called "nominated" with the year (as key) and list of directors 
# who were nominated in that year (as value)
...
for year, nom_directors in nominated.items():
    for director in nom_directors:
...
win_count_dict = {}
# First we create a dict to find out how many times the director won
for year, director in winners.items():
    for winner in director:
        win_count_dict[winner] = win_count_dict.get(winner, 0) + 1
...
# Next find who is the most winning director
most_win_director = []
highest_count = 0
